(() => {
  ...
  // node_modules/.pnpm/air-datepicker@3.6.0/node_modules/air-datepicker/air-datepicker.js
  var require_air_datepicker = __commonJS({
    "node_modules/.pnpm/air-datepicker@3.6.0/node_modules/air-datepicker/air-datepicker.js"(exports, module) {
      init_live_reload();
      !function(e, t) {
  ...
  // node_modules/.pnpm/air-datepicker@3.6.0/node_modules/air-datepicker/locale/nl.js
  var require_nl = __commonJS({
    "node_modules/.pnpm/air-datepicker@3.6.0/node_modules/air-datepicker/locale/nl.js"(exports) {
      "use strict";
      init_live_reload();
  ...
  // node_modules/.pnpm/air-datepicker@3.6.0/node_modules/air-datepicker/locale/en.js
  var require_en = __commonJS({
    "node_modules/.pnpm/air-datepicker@3.6.0/node_modules/air-datepicker/locale/en.js"(exports) {
      "use strict";
      init_live_reload();
      Object.defineProperty(exports, "__esModule", {
        value: true
  ...
  var DATE_MIN_OFFSET_DAYS = 1;
  var DATE_MAX_OFFSET_DAYS = 365 * 2;
  function getLocale() {
    const docLang = document.documentElement.lang || "nl";
    const locales = { nl: import_nl.default, en: import_en.default };
    return (locales[docLang.toLowerCase()] || import_nl.default).default;
  }
  ...
  function setupComboboxClear() {
    document.querySelectorAll('[fs-list-element="clear"], [fs-combobox-element="clear"]').forEach(
  ...
  function getDefaultDatePickerConfig() {
    return {
      ...
      range: true,
      minDate: new Date(Date.now() + DATE_MIN_OFFSET_DAYS * 24 * 60 * 60 * 1e3),
      maxDate: new Date(Date.now() + DATE_MAX_OFFSET_DAYS * 24 * 60 * 60 * 1e3),
